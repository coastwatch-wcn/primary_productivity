...
![](images/fig3_psi_with_centered_colorbar.png){.lightbox width=70%}
...
::: {style="text-align: center;"}
![](images/slope_npp.png){.lightbox width=80%}
...
![](images/fig5_trends_with_centered_colorbar.png){.lightbox width=100%}
...
::: {style="text-align: center;"}
![](images/Contingency_figure.png){.lightbox width=500}
