...
::: {.grid}
::::{.g-col-6}
![](images/ccal_psi_netpp.png){width=100%}
::::
:::: {.g-col-6}
Calculate the mean unbiased relative difference ($\psi$) between the legacy and interim products for a user-specified region.

[Python Tutorial](https://github.com/coastwatch-wcn/primary_productivity/blob/main/tutorials/Python/longhurst/unbiased_relative_difference/longhurst_unbiased_relative_difference.ipynb)
[R Tutorial](https://github.com/coastwatch-wcn/primary_productivity/blob/main/tutorials/R/longhurst/unbiased_relative_difference/longhurst_unbiased_relative_difference.Rmd)
::::
:::
...
::: {.grid}
::::{.g-col-6}
![](images/carb_delta_netpp.png){width=100%}
::::
:::: {.g-col-6}
Calculate the absolute relative difference ($\Delta$) between the legacy and interim products for a user-specified region.

[Python Tutorial](https://github.com/coastwatch-wcn/primary_productivity/blob/main/tutorials/Python/longhurst/absolute_relative_difference/longhurst_absolute_relative_difference.ipynb)
[R Tutorial](https://github.com/coastwatch-wcn/primary_productivity/blob/main/tutorials/R/longhurst/absolute_relative_difference/longhurst_absolute_relative_difference.Rmd)
::::
:::
...
::: {.grid}
::::{.g-col-6}
![](images/CCAL_3x3_contingency.png){width=100%}
::::
:::: {.g-col-6}
Construct a contingency matrix to compare the trends between the legacy and interim products for a user-specified region.

[Python Tutorial](https://github.com/coastwatch-wcn/primary_productivity/blob/main/tutorials/Python/longhurst/contingency_matrix/longhurst_contingency_matrices.ipynb)
[R Tutorial](https://github.com/coastwatch-wcn/primary_productivity/blob/main/tutorials/R/longhurst/contigency_matrix/longhurst_contingency_matrices.Rmd)
::::
:::
...
[Python Tutorial](https://github.com/coastwatch-wcn/primary_productivity/blob/main/tutorials/Python/raw_calculations/unbiased_relative_difference/raw_unbiased_relative_difference.ipynb)
[R Tutorial](https://github.com/coastwatch-wcn/primary_productivity/blob/main/tutorials/R/raw_calculations/unbiased_relative_difference/raw_unbiased_relative_difference.Rmd)
::::
:::
...
[Python Tutorial](https://github.com/coastwatch-wcn/primary_productivity/blob/main/tutorials/Python/raw_calculations/absolute_relative_difference/raw_absolute_relative_difference.ipynb)
[R Tutorial](https://github.com/coastwatch-wcn/primary_productivity/blob/main/tutorials/R/raw_calculations/absolute_relative_difference/raw_absolute_relative_difference.Rmd)
::::
:::
...
[Python Tutorial](https://github.com/coastwatch-wcn/primary_productivity/blob/main/tutorials/Python/raw_calculations/trends/raw_trends_primary_productivity.ipynb)
[R Tutorial](https://github.com/coastwatch-wcn/primary_productivity/blob/main/tutorials/R/raw_calculations/trends/raw_trends_primary_productivity.Rmd)
::::
:::
...
<ul>
  ...
  <li><a>MODIS Aqua input data for legacy netPP</a></li>
    <ul>
      <li><a href="https://coastwatch.pfeg.noaa.gov/erddap/griddap/erdMH1chlamday_R2022SQ.graph">MODIS Chlorophyll a</a></li>
      <li><a href="https://coastwatch.pfeg.noaa.gov/erddap/griddap/erdMH1par0mday_R2022SQ.graph">MODIS PAR</a></li>
      <li><a href="https://www.earthdata.nasa.gov/">MODIS SST</a></li>
    </ul>
  <li><a>VIIRS SNPP input data for interim netPP</a></li>
    <ul>
      <li><a href="https://coastwatch.pfeg.noaa.gov/erddap/griddap/erdVH2018chlamday.graph">VIIRS SNPP Chlorophyll a</a></li>
      <li><a href="https://coastwatch.pfeg.noaa.gov/erddap/griddap/erdVH2018parmday.graph">VIIRS SNPP PAR</a></li>
